...
export const api = (): WebApiSetup => (router: Router): void => {
    ...
    /**
     * @openapi
     * /api/day6/placereservation/{eMail}:
     *   post:
     *     tags: [Day6]
     *     summary: PlaceReservation
     *     description: >
     *       Places a reservation for a guest. The reservationCode is generated at placement —
     *       it is returned here, shown to the guest and used later to confirm or cancel.
     *     parameters:
     *       - in: path
     *         name: eMail
     *         required: true
     ...
     */
    router.post('/api/day6/placereservation/:eMail', async (req: Request, res: Response) => {
